...
const TripSchema = new mongoose.Schema(
  {
    ...
    usefulInformationTitle: { type: String, trim: true },
    usefulInformationShortDescription: { type: String, trim: true },
    usefulInformationLongDescription: { type: String, trim: true },
